...
public class SharedPreferencesUtil {
	...
	public static void ClearSharedPreferences(String dataBasesName) {
		SharedPreferences user = LocationApplication.getInstance().getSharedPreferences(dataBasesName, 0);
	...
	public static void WriteSharedPreferences(String dataBasesName,	String name, Object value) {
		...
		SharedPreferences user = LocationApplication.getInstance().getSharedPreferences(
				dataBasesName, 0);
		Editor editor = user.edit();
